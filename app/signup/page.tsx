...
const socialProviders = [
  ...
  },
  {
    ...
    className:
      "w-full h-11 border-2 hover:border-gray-800 dark:hover:border-gray-400 hover:bg-gray-50 dark:hover:bg-gray-950/20 transition-all",
    icon: (
  ...
  },
  {
    ...
    className:
      "w-full h-11 border-2 hover:border-black/80 hover:bg-black/5 dark:hover:bg-white/10 transition-all",
    icon: (
